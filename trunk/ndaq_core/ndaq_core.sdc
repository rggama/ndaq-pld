...
set_clock_groups -asynchronous -group {spi_clk} {clk_in adc12_clk adc34_clk adc56_clk adc78_clk virtual_dco} -group {clock_manager|core_pll_inst|altpll_component|auto_generated|pll1|clk[0] clock_manager|core_pll_inst|altpll_component|auto_generated|pll1|clk[2]}
