...
add wave -noupdate -format Logic /ndaq_sim_tbench/ndaq_vme_fpga/usb_readout_construct__0/idt_to_intfifo/ena
add wave -noupdate -format Logic /ndaq_sim_tbench/ndaq_vme_fpga/usb_readout_construct__0/idt_to_intfifo/enb
add wave -noupdate -format Logic /ndaq_sim_tbench/ndaq_vme_fpga/usb_readout_construct__0/idt_to_intfifo/a_ff
add wave -noupdate -format Logic /ndaq_sim_tbench/ndaq_vme_fpga/usb_readout_construct__0/idt_to_intfifo/a_wr
add wave -noupdate -format Logic /ndaq_sim_tbench/ndaq_vme_fpga/usb_readout_construct__0/idt_to_intfifo/b_ff
add wave -noupdate -format Logic /ndaq_sim_tbench/ndaq_vme_fpga/usb_readout_construct__0/idt_to_intfifo/b_wr
...
add wave -noupdate -format Literal -radix hexadecimal /ndaq_sim_tbench/ndaq_vme_fpga/usb_readout_construct__0/a_readout_fifo/data
add wave -noupdate -format Logic /ndaq_sim_tbench/ndaq_vme_fpga/usb_readout_construct__0/a_readout_fifo/rdreq
add wave -noupdate -format Logic /ndaq_sim_tbench/ndaq_vme_fpga/usb_readout_construct__0/a_readout_fifo/wrreq
add wave -noupdate -format Logic /ndaq_sim_tbench/ndaq_vme_fpga/usb_readout_construct__0/a_readout_fifo/empty
add wave -noupdate -format Logic /ndaq_sim_tbench/ndaq_vme_fpga/usb_readout_construct__0/a_readout_fifo/full
add wave -noupdate -format Literal -radix hexadecimal /ndaq_sim_tbench/ndaq_vme_fpga/usb_readout_construct__0/a_readout_fifo/q
add wave -noupdate -format Literal -radix hexadecimal /ndaq_sim_tbench/ndaq_vme_fpga/usb_readout_construct__0/a_readout_fifo/usedw
add wave -noupdate -divider {B Readout FIFO}
add wave -noupdate -format Literal -radix hexadecimal /ndaq_sim_tbench/ndaq_vme_fpga/usb_readout_construct__0/b_readout_fifo/data
add wave -noupdate -format Logic /ndaq_sim_tbench/ndaq_vme_fpga/usb_readout_construct__0/b_readout_fifo/rdreq
add wave -noupdate -format Logic /ndaq_sim_tbench/ndaq_vme_fpga/usb_readout_construct__0/b_readout_fifo/wrreq
add wave -noupdate -format Logic /ndaq_sim_tbench/ndaq_vme_fpga/usb_readout_construct__0/b_readout_fifo/empty
add wave -noupdate -format Logic /ndaq_sim_tbench/ndaq_vme_fpga/usb_readout_construct__0/b_readout_fifo/full
add wave -noupdate -format Literal -radix hexadecimal /ndaq_sim_tbench/ndaq_vme_fpga/usb_readout_construct__0/b_readout_fifo/q
add wave -noupdate -format Literal -radix hexadecimal /ndaq_sim_tbench/ndaq_vme_fpga/usb_readout_construct__0/b_readout_fifo/usedw
add wave -noupdate -divider {A Int FIFO to FT245BM if}
add wave -noupdate -format Logic /ndaq_sim_tbench/ndaq_vme_fpga/usb_readout_construct__0/a_to_ft_copier/enable
add wave -noupdate -format Logic /ndaq_sim_tbench/ndaq_vme_fpga/usb_readout_construct__0/a_to_ft_copier/isidle
add wave -noupdate -format Logic /ndaq_sim_tbench/ndaq_vme_fpga/usb_readout_construct__0/a_to_ft_copier/ef
add wave -noupdate -format Literal -radix hexadecimal /ndaq_sim_tbench/ndaq_vme_fpga/usb_readout_construct__0/a_to_ft_copier/usedw
add wave -noupdate -format Logic /ndaq_sim_tbench/ndaq_vme_fpga/usb_readout_construct__0/a_to_ft_copier/rd
add wave -noupdate -format Literal -radix hexadecimal /ndaq_sim_tbench/ndaq_vme_fpga/usb_readout_construct__0/a_to_ft_copier/q
add wave -noupdate -format Logic /ndaq_sim_tbench/ndaq_vme_fpga/usb_readout_construct__0/a_to_ft_copier/dwait
add wave -noupdate -format Logic /ndaq_sim_tbench/ndaq_vme_fpga/usb_readout_construct__0/a_to_ft_copier/wr
add wave -noupdate -format Literal -radix hexadecimal /ndaq_sim_tbench/ndaq_vme_fpga/usb_readout_construct__0/a_to_ft_copier/odata
add wave -noupdate -format Literal /ndaq_sim_tbench/ndaq_vme_fpga/usb_readout_construct__0/a_to_ft_copier/state
add wave -noupdate -divider {B Int FIFO to FT245BM if}
add wave -noupdate -format Logic /ndaq_sim_tbench/ndaq_vme_fpga/usb_readout_construct__0/b_to_ft_copier/enable
add wave -noupdate -format Logic /ndaq_sim_tbench/ndaq_vme_fpga/usb_readout_construct__0/b_to_ft_copier/isidle
add wave -noupdate -format Logic /ndaq_sim_tbench/ndaq_vme_fpga/usb_readout_construct__0/b_to_ft_copier/ef
add wave -noupdate -format Literal -radix hexadecimal /ndaq_sim_tbench/ndaq_vme_fpga/usb_readout_construct__0/b_to_ft_copier/usedw
add wave -noupdate -format Logic /ndaq_sim_tbench/ndaq_vme_fpga/usb_readout_construct__0/b_to_ft_copier/rd
add wave -noupdate -format Literal -radix hexadecimal /ndaq_sim_tbench/ndaq_vme_fpga/usb_readout_construct__0/b_to_ft_copier/q
add wave -noupdate -format Logic /ndaq_sim_tbench/ndaq_vme_fpga/usb_readout_construct__0/b_to_ft_copier/dwait
add wave -noupdate -format Logic /ndaq_sim_tbench/ndaq_vme_fpga/usb_readout_construct__0/b_to_ft_copier/wr
add wave -noupdate -format Literal -radix hexadecimal /ndaq_sim_tbench/ndaq_vme_fpga/usb_readout_construct__0/b_to_ft_copier/odata
add wave -noupdate -format Literal /ndaq_sim_tbench/ndaq_vme_fpga/usb_readout_construct__0/b_to_ft_copier/state
...
WaveRestoreCursors {{Cursor 1} {284616804 ps} 0} {{Cursor 2} {13022895 ps} 0} {{Cursor 3} {49635650 ps} 0}
...
update
WaveRestoreZoom {0 ps} {177602560 ps}
