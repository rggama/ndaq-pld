...
add wave -noupdate -format Logic /spi_tbench/master_spi/dwait
...
add wave -noupdate -format Logic /spi_tbench/slave_spi/dwait
...
add wave -noupdate -format Logic /spi_tbench/slave_spi/txload
TreeUpdate [SetDefaultTree]
WaveRestoreCursors {{Cursor 1} {10503104 ps} 0} {{Cursor 2} {5225364 ps} 0}
...
update
WaveRestoreZoom {0 ps} {14724288 ps}
